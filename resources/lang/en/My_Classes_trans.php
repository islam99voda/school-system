...
return [
    ...
    'Warning_Grade'=> 'are you sure that you want to delete ?',
    'class_ar_required'=> 'name class in Arabic is required.',
    'class_en_required'=> 'name class in Arabic is required.',
    'submit' => 'submit',
